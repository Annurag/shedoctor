 ...
 */
public class UpcomingApointAdapter extends RecyclerView.Adapter<UpcomingApointAdapter.MyViewHolder> {
    ...
    public UpcomingApointAdapter(Context context, ArrayList<UpcomingApointItem> upcomingApointItemArrayList) {
        this.upcomingApointItemArrayList = upcomingApointItemArrayList;
        this.context = context;
    }

    public UpcomingApointAdapter(Context context) {
        this.context = context;
    }
